...
#pybabel extract -o src/translations/messages.pot .

#pybabel init -i src/translations/messages.pot -d src/translations -l en
#pybabel init -i src/translations/messages.pot -d src/translations -l uk
